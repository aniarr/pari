...
// Get ALL user details from `users_details` table
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="home.php" class="nav-link flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-800">
                ...
                <div class="relative">
                    <div class="flex items-center space-x-3 cursor-pointer" id="profileButton">
                        <div class="hidden sm:block text-right">
                            <p class="text-white font-medium text-sm"><?= htmlspecialchars($userData['name']) ?></p>
                        </div>
            ...
            <div class="md:hidden flex justify-around py-3 border-t border-gray-800">
                <a href="index.php" class="flex flex-col items-center space-y-1 text-gray-400"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/></svg><span class="text-xs">Home</span></a>
            ...
            <div class="mb-8">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-2">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500">
                        <?= htmlspecialchars(explode(" ", $userData['name'])[0]) ?>
                    </span>
                </h1>
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
                        <div class="trainer-avatar relative group">
                            <div class="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden border-4 border-orange-500/30 shadow-xl transition-all duration-500 group-hover:border-orange-400 group-hover:shadow-2xl group-hover:scale-105">
                                <?php 
                                $img = '';
                                $imgField = trim($userData['profile_image'] ?? '');
                                if ($imgField && file_exists('uploads/' . $imgField)) {
                                    $img = 'uploads/' . $imgField;
                                } elseif ($imgField && filter_var($imgField, FILTER_VALIDATE_URL)) {
                                    $img = $imgField;
                                }
                                ?>
                                <?php if ($img): ?>
                                    <img src="<?= htmlspecialchars($img) ?>" alt="Profile" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                <?php else: ?>
                                    <div class="w-full h-full bg-gradient-to-br from-orange-500 via-red-500 to-pink-600 flex items-center justify-center text-white text-3xl md:text-4xl font-bold animate-pulse-slow">
                                        <?= strtoupper(substr($userData['name'], 0, 1)) ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="absolute -bottom-2 -right-2 w-10 h-10 bg-green-500 rounded-full border-4 border-gray-900 flex items-center justify-center shadow-lg animate-pulse">
                        ...
                        <div class="text-center sm:text-left">
                            <h2 class="text-3xl md:text-4xl font-bold text-white flex items-center gap-3 justify-center sm:justify-start">
                                ...
                                <span class="text-sm bg-gradient-to-r from-orange-400 to-red-500 text-white px-3 py-1 rounded-full font-medium">Member</span>
                            </h2>
                            <p class="text-gray-400 text-sm mt-1 flex items-center gap-2 justify-center sm:justify-start">
                                ...
                                Member since: <?= $userData['created_at'] ? date('F Y', strtotime($userData['created_at'])) : 'N/A' ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-800/70 backdrop-blur-md rounded-xl p-6 md:p-7 border border-gray-700/50">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium truncate"><?= htmlspecialchars($userData['email']) ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['phone'] ?: 'N/A') ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['address'] ?: 'Not set') ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['age'] ?: 'N/A') ?> years</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= $userData['dob'] ? date('F j, Y', strtotime($userData['dob'])) : 'Not set' ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['blood_group'] ?: 'N/A') ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['location'] ?: 'Not set') ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-medium"><?= htmlspecialchars($userData['gender'] ?: 'Not set') ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-1">
                                        <?php foreach (array_filter(array_map('trim', explode(',', $userData['interests']))) as $i): ?>
                                        <span class="px-2 py-1 bg-gradient-to-r from-orange-500/20 to-red-500/20 text-orange-300 border border-orange-500/30 rounded-full text-xs font-medium">
                                            <?= htmlspecialchars($i) ?>
                                        </span>
                                        <?php endforeach; ?>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-6">
                            ...
                            <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                ...
                                <a href="<?= htmlspecialchars($userData['website']) ?>" target="_blank" class="text-orange-400 hover:text-orange-300 transition-colors text-sm flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/>
                                    </svg>
                                    <?= htmlspecialchars(parse_url($userData['website'], PHP_URL_HOST)) ?>
                                </a>
                            </div>
                            <?php endif; ?>

                            <?php if (!empty(trim($userData['social_links']))): ?>
                            <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                                <p class="text-xs text-gray-400 mb-1">Social Links</p>
                                <div class="flex gap-3">
                                    <?php 
                                    $links = json_decode($userData['social_links'], true) ?: [];
                                    foreach ($links as $platform => $url):
                                        if (empty($url)) continue;
                                    ?>
                                    <a href="<?= htmlspecialchars($url) ?>" target="_blank" class="text-orange-500 hover:text-orange-300">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                            <use xlink:href="#icon-<?= strtolower($platform) ?>"></use>
                                        </svg>
                                    </a>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="flex items-center gap-2 text-xs text-gray-500 mt-6 pt-4 border-t border-gray-700/50">
                            ...
                            Last Updated: <?= $userData['updated_at'] ? date('M j, Y \a\t g:i A', strtotime($userData['updated_at'])) : 'Never' ?>
                        </div>
                    </div>

                    <!-- Edit Button -->
                    <div class="mt-8 flex justify-center md:justify-end">
                        <a href="edit_profile.php" class="group inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="transition-transform group-hover:translate-x-1">
